...
|------------- | ------------- | -------------|
| [**organizationUsageCountOrganizationUsage**](OrganizationUsageApi.md#organizationusagecountorganizationusage) | **GET** /api/v1/organizations/me/usage/count | Count Organization Usage |
| [**organizationUsageListOrganizationUsage**](OrganizationUsageApi.md#organizationusagelistorganizationusage) | **GET** /api/v1/organizations/me/usage | List Organization Usage |
| [**organizationUsageOrganizationUsageSeries**](OrganizationUsageApi.md#organizationusageorganizationusageseries) | **GET** /api/v1/organizations/me/usage/series | Organization Usage Series |
| [**organizationUsageOrganizationUsageSummary**](OrganizationUsageApi.md#organizationusageorganizationusagesummary) | **GET** /api/v1/organizations/me/usage/summary | Organization Usage Summary |
...
import type { OrganizationUsageCountOrganizationUsageRequest } from '';
...
async function example() {
  ...
  } satisfies OrganizationUsageCountOrganizationUsageRequest;

  try {
    const data = await api.organizationUsageCountOrganizationUsage(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OrganizationUsageListOrganizationUsageRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // number (optional)
    limit: 56,
  } satisfies OrganizationUsageListOrganizationUsageRequest;

  try {
    const data = await api.organizationUsageListOrganizationUsage(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OrganizationUsageOrganizationUsageSeriesRequest } from '';
...
async function example() {
  ...
  } satisfies OrganizationUsageOrganizationUsageSeriesRequest;

  try {
    const data = await api.organizationUsageOrganizationUsageSeries(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OrganizationUsageOrganizationUsageSummaryRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.organizationUsageOrganizationUsageSummary(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
