...
> AcceptInvitationResultPublic organizationsAcceptCallerPendingMembership(organizationMemberId)
...
import type { OrganizationsAcceptCallerPendingMembershipRequest } from '';
...
async function example() {
  ...
  } satisfies OrganizationsAcceptCallerPendingMembershipRequest;

  try {
    const data = await api.organizationsAcceptCallerPendingMembership(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OrganizationDomainPublic organizationsCreateActiveOrganizationDomain(organizationDomainCreateRequest)
...
import type { OrganizationsCreateActiveOrganizationDomainRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    organizationDomainCreateRequest: ...,
  } satisfies OrganizationsCreateActiveOrganizationDomainRequest;

  try {
    const data = await api.organizationsCreateActiveOrganizationDomain(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> ActiveOrganizationMemberCreateResultPublic organizationsCreateActiveOrganizationMember(activeOrganizationMemberCreateRequest)
...
import type { OrganizationsCreateActiveOrganizationMemberRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    activeOrganizationMemberCreateRequest: ...,
  } satisfies OrganizationsCreateActiveOrganizationMemberRequest;

  try {
    const data = await api.organizationsCreateActiveOrganizationMember(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OrganizationPublic organizationsCreateOrganization(organizationCreateRequest)
...
import type { OrganizationsCreateOrganizationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    organizationCreateRequest: ...,
  } satisfies OrganizationsCreateOrganizationRequest;

  try {
    const data = await api.organizationsCreateOrganization(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Message organizationsDeclineCallerPendingMembership(organizationMemberId)
...
import type { OrganizationsDeclineCallerPendingMembershipRequest } from '';
...
async function example() {
  ...
  const body = {
    // string
    organizationMemberId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies OrganizationsDeclineCallerPendingMembershipRequest;

  try {
    const data = await api.organizationsDeclineCallerPendingMembership(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Message organizationsDeleteActiveOrganizationDomain(organizationDomainId)
...
import type { OrganizationsDeleteActiveOrganizationDomainRequest } from '';
...
async function example() {
  ...
  } satisfies OrganizationsDeleteActiveOrganizationDomainRequest;

  try {
    const data = await api.organizationsDeleteActiveOrganizationDomain(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OrganizationMembershipContextPublic organizationsGetActiveOrganizationContext()
...
import type { OrganizationsGetActiveOrganizationContextRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.organizationsGetActiveOrganizationContext();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> InviteOrganizationMemberResultPublic organizationsInviteActiveOrganizationMember(inviteOrganizationMemberRequest)
...
import type { OrganizationsInviteActiveOrganizationMemberRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    inviteOrganizationMemberRequest: ...,
  } satisfies OrganizationsInviteActiveOrganizationMemberRequest;

  try {
    const data = await api.organizationsInviteActiveOrganizationMember(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OrganizationDomainsPublic organizationsListActiveOrganizationDomains()
...
import type { OrganizationsListActiveOrganizationDomainsRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.organizationsListActiveOrganizationDomains();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { OrganizationsListActiveOrganizationMembersRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.organizationsListActiveOrganizationMembers(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> CallerOrganizationMembershipsPublic organizationsListCallerOrganizationMemberships(skip, limit)
...
import type { OrganizationsListCallerOrganizationMembershipsRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // number | Maximum number of records to return (optional)
    limit: 56,
  } satisfies OrganizationsListCallerOrganizationMembershipsRequest;

  try {
    const data = await api.organizationsListCallerOrganizationMemberships(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> PendingOrganizationInvitationsPublic organizationsListCallerPendingMemberships(skip, limit)
...
import type { OrganizationsListCallerPendingMembershipsRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // number | Maximum number of records to return (optional)
    limit: 56,
  } satisfies OrganizationsListCallerPendingMembershipsRequest;

  try {
    const data = await api.organizationsListCallerPendingMemberships(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Message organizationsRemoveActiveOrganizationMember(organizationMemberId)
...
import type { OrganizationsRemoveActiveOrganizationMemberRequest } from '';
...
async function example() {
  ...
  const body = {
    // string
    organizationMemberId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies OrganizationsRemoveActiveOrganizationMemberRequest;

  try {
    const data = await api.organizationsRemoveActiveOrganizationMember(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Message organizationsRevokeActiveOrganizationMemberInvitation(invitationId)
...
import type { OrganizationsRevokeActiveOrganizationMemberInvitationRequest } from '';
...
async function example() {
  ...
  } satisfies OrganizationsRevokeActiveOrganizationMemberInvitationRequest;

  try {
    const data = await api.organizationsRevokeActiveOrganizationMemberInvitation(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OrganizationMembershipContextPublic organizationsSwitchActiveOrganization(switchActiveOrganizationRequest)
...
import type { OrganizationsSwitchActiveOrganizationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    switchActiveOrganizationRequest: ...,
  } satisfies OrganizationsSwitchActiveOrganizationRequest;

  try {
    const data = await api.organizationsSwitchActiveOrganization(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OrganizationMembershipContextPublic organizationsUpdateActiveOrganization(activeOrganizationUpdateRequest)
...
import type { OrganizationsUpdateActiveOrganizationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    activeOrganizationUpdateRequest: ...,
  } satisfies OrganizationsUpdateActiveOrganizationRequest;

  try {
    const data = await api.organizationsUpdateActiveOrganization(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OrganizationDomainPublic organizationsUpdateActiveOrganizationDomain(organizationDomainId, organizationDomainUpdateRequest)
...
import type { OrganizationsUpdateActiveOrganizationDomainRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    organizationDomainUpdateRequest: ...,
  } satisfies OrganizationsUpdateActiveOrganizationDomainRequest;

  try {
    const data = await api.organizationsUpdateActiveOrganizationDomain(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> ActiveOrganizationMemberPublic organizationsUpdateActiveOrganizationMember(organizationMemberId, activeOrganizationMemberUpdateRequest)
...
import type { OrganizationsUpdateActiveOrganizationMemberRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    activeOrganizationMemberUpdateRequest: ...,
  } satisfies OrganizationsUpdateActiveOrganizationMemberRequest;

  try {
    const data = await api.organizationsUpdateActiveOrganizationMember(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OrganizationDomainPublic organizationsVerifyActiveOrganizationDomain(organizationDomainId)
...
import type { OrganizationsVerifyActiveOrganizationDomainRequest } from '';
...
async function example() {
  ...
  const body = {
    // string
    organizationDomainId: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies OrganizationsVerifyActiveOrganizationDomainRequest;

  try {
    const data = await api.organizationsVerifyActiveOrganizationDomain(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
