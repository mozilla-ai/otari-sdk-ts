...
> AcceptInvitationResultPublic invitationsAcceptInvitation(acceptInvitationRequest)
...
import type { InvitationsAcceptInvitationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    acceptInvitationRequest: ...,
  } satisfies InvitationsAcceptInvitationRequest;

  try {
    const data = await api.invitationsAcceptInvitation(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> InvitationPreviewPublic invitationsValidateInvitation(validateInvitationRequest)
...
import type { InvitationsValidateInvitationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    validateInvitationRequest: ...,
  } satisfies InvitationsValidateInvitationRequest;

  try {
    const data = await api.invitationsValidateInvitation(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
