...
export interface SetPricingRequest {
     ...
     * @type {SetPricingRequestUnitEnum}
     * @memberof SetPricingRequest
     */
    unit?: SetPricingRequestUnitEnum;
}
 ...
 * @export
 */
export const SetPricingRequestUnitEnum = {
    Tokens: 'tokens',
    Requests: 'requests',
    Images: 'images'
} as const;
export type SetPricingRequestUnitEnum = typeof SetPricingRequestUnitEnum[keyof typeof SetPricingRequestUnitEnum];
