...
import type { CCImageContent } from './CCImageContent.js';
import {
    CCImageContentFromJSON,
    CCImageContentFromJSONTyped,
    CCImageContentToJSON,
    CCImageContentToJSONTyped,
} from './CCImageContent.js';
...
export interface CCChatCompletionMessage {
    ...
    /**
     * 
     * @type {Array<CCImageContent>}
     * @memberof CCChatCompletionMessage
     */
    images?: Array<CCImageContent> | null;
}
...
export function CCChatCompletionMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): CCChatCompletionMessage {
    ...
    return {
        ...
        'images': json['images'] == null ? undefined : ((json['images'] as Array<any>).map(CCImageContentFromJSON)),
    };
}
...
export function CCChatCompletionMessageToJSONTyped(value?: CCChatCompletionMessage | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'images': value['images'] == null ? undefined : ((value['images'] as Array<any>).map(CCImageContentToJSON)),
    };
}
