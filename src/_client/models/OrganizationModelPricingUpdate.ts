...
export interface OrganizationModelPricingUpdate {
     ...
     * @type {OrganizationModelPricingUpdateUnitEnum}
     * @memberof OrganizationModelPricingUpdate
     */
    unit?: OrganizationModelPricingUpdateUnitEnum;
}
 ...
 * @export
 */
export const OrganizationModelPricingUpdateUnitEnum = {
    Tokens: 'tokens',
    Requests: 'requests',
    Images: 'images'
} as const;
export type OrganizationModelPricingUpdateUnitEnum = typeof OrganizationModelPricingUpdateUnitEnum[keyof typeof OrganizationModelPricingUpdateUnitEnum];
