...
export interface OrganizationModelPricingCreate {
     ...
     * @type {OrganizationModelPricingCreateUnitEnum}
     * @memberof OrganizationModelPricingCreate
     */
    unit?: OrganizationModelPricingCreateUnitEnum;
}
 ...
 * @export
 */
export const OrganizationModelPricingCreateUnitEnum = {
    Tokens: 'tokens',
    Requests: 'requests',
    Images: 'images'
} as const;
export type OrganizationModelPricingCreateUnitEnum = typeof OrganizationModelPricingCreateUnitEnum[keyof typeof OrganizationModelPricingCreateUnitEnum];
