...
export function instanceOfDeploymentBootstrap(value: object): value is DeploymentBootstrap {
    ...
    if (!('feedbackEnabled' in value) || value['feedbackEnabled'] === undefined) return false;
    ...
    if (!('openSignup' in value) || value['openSignup'] === undefined) return false;
...
export function DeploymentBootstrapFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeploymentBootstrap {
    ...
    return {
        ...
        'feedbackEnabled': json['feedback_enabled'],
