...
import {
    type BuiltInGuardrailCatalog,
    BuiltInGuardrailCatalogFromJSON,
    BuiltInGuardrailCatalogToJSON,
} from '../models/BuiltInGuardrailCatalog.js';
import {
...
export class ToolSettingsApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for toolSettingsListBuiltinGuardrails without sending the request
     */
    async toolSettingsListBuiltinGuardrailsRequestOpts(): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/api/v1/tool-settings/guardrails/catalog`;
     ...
     */
    async toolSettingsListBuiltinGuardrailsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BuiltInGuardrailCatalog>> {
        const requestOptions = await this.toolSettingsListBuiltinGuardrailsRequestOpts();
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => BuiltInGuardrailCatalogFromJSON(jsonValue));
    }
     ...
     * List Builtin Guardrails
     */
    async toolSettingsListBuiltinGuardrails(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BuiltInGuardrailCatalog> {
        const response = await this.toolSettingsListBuiltinGuardrailsRaw(initOverrides);
        return await response.value();
    }
