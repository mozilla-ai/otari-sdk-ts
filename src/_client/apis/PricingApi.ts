...
import {
    type AcceptedSnapshotResponse,
    AcceptedSnapshotResponseFromJSON,
    AcceptedSnapshotResponseToJSON,
} from '../models/AcceptedSnapshotResponse.js';
import {
    type CurrentPricingPage,
    CurrentPricingPageFromJSON,
    CurrentPricingPageToJSON,
} from '../models/CurrentPricingPage.js';
import {
...
import {
    ...
    PricingDriftRowFromJSON,
    PricingDriftRowToJSON,
} from '../models/PricingDriftRow.js';
import {
...
export interface PricingListCurrentPricingRequest {
    skip?: number;
    limit?: number;
}
...
export interface PricingListPricingDriftRequest {
    limit?: number;
}

export interface PricingListPricingSnapshotsRequest {
    limit?: number;
}
...
export class PricingApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for pricingGetPendingPricingRefresh without sending the request
     */
    async pricingGetPendingPricingRefreshRequestOpts(): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/api/v1/pricing/refresh/pending`;
     ...
     */
    async pricingGetPendingPricingRefreshRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PricingRefreshPreviewResponse>> {
        const requestOptions = await this.pricingGetPendingPricingRefreshRequestOpts();
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Get Pending Pricing Refresh
     */
    async pricingGetPendingPricingRefresh(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PricingRefreshPreviewResponse> {
        const response = await this.pricingGetPendingPricingRefreshRaw(initOverrides);
        return await response.value();
    }
    ...
    /**
     * Creates request options for pricingListCurrentPricing without sending the request
     */
    async pricingListCurrentPricingRequestOpts(requestParameters: PricingListCurrentPricingRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/api/v1/pricing/current`;
     ...
     */
    async pricingListCurrentPricingRaw(requestParameters: PricingListCurrentPricingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrentPricingPage>> {
        const requestOptions = await this.pricingListCurrentPricingRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CurrentPricingPageFromJSON(jsonValue));
    }
     ...
     * List Current Pricing
     */
    async pricingListCurrentPricing(requestParameters: PricingListCurrentPricingRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrentPricingPage> {
        const response = await this.pricingListCurrentPricingRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     * Creates request options for pricingListPricingDrift without sending the request
     */
    async pricingListPricingDriftRequestOpts(requestParameters: PricingListPricingDriftRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/api/v1/pricing/drift`;
     ...
     * List Pricing Drift
     */
    async pricingListPricingDriftRaw(requestParameters: PricingListPricingDriftRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<PricingDriftRow>>> {
        const requestOptions = await this.pricingListPricingDriftRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(PricingDriftRowFromJSON));
    }
     ...
     * List Pricing Drift
     */
    async pricingListPricingDrift(requestParameters: PricingListPricingDriftRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<PricingDriftRow>> {
        const response = await this.pricingListPricingDriftRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for pricingListPricingSnapshots without sending the request
     */
    async pricingListPricingSnapshotsRequestOpts(requestParameters: PricingListPricingSnapshotsRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/api/v1/pricing/snapshots`;
     ...
     */
    async pricingListPricingSnapshotsRaw(requestParameters: PricingListPricingSnapshotsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<AcceptedSnapshotResponse>>> {
        const requestOptions = await this.pricingListPricingSnapshotsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(AcceptedSnapshotResponseFromJSON));
    }
     ...
     * List Pricing Snapshots
     */
    async pricingListPricingSnapshots(requestParameters: PricingListPricingSnapshotsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<AcceptedSnapshotResponse>> {
        const response = await this.pricingListPricingSnapshotsRaw(requestParameters, initOverrides);
        return await response.value();
    }
