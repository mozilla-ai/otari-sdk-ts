...
* target the gateway's /api/v1 prefix

### Features

* target the gateway's /api/v1 prefix ([5ff69a4](https://github.com/mozilla-ai/otari-sdk-ts/commit/5ff69a476ad19ba1f22ea46474515401449f0ab9))
